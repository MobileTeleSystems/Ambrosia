...
@pytest.fixture()
@pytest.mark.tester()
def results_ltv_retention_conversions_spark(results_ltv_retention_conversions, local_spark_session):
...
@pytest.fixture()
@pytest.mark.tester()
def tester_spark_ltv_ret(results_ltv_retention_conversions_spark):
    """
    Spark tester
    """
    tester = Tester(dataframe=results_ltv_retention_conversions_spark,
